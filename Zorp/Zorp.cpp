...
void main()
{
	...
	std::cout << INDENT << "ZORP is a game of adventure, danger, and low cunning."
		<< std::endl;
	...
	//move the cursor to the start of 1st question
	std::cout << RESTORE_CURSOR_POS;
	...
	std::cout << CSI << "4M"; //delet the next 4 lines of text
